...
| R-07 | P1 | coupling | ChatGPT routing, UI, handlers, and runtime JS are monolithic inside `web/index.php`, high refactor blast radius. | `web/index.php:1-420`, `web/index.php:6002-7914` |
